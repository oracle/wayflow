...
### *class* wayflowcore.models.ocigenaimodel.OCIGenAIModel(\*, model_id, compartment_id=None, client_config=None, serving_mode=None, provider=None, generation_config=None, id=None, name=None, description=None, \_\_metadata_info_\_=None, service_endpoint=None, auth_type=None, auth_profile='DEFAULT')
