...
### *class* wayflowcore.transforms.CanonicalizationMessageTransform
...
* **Parameters:**
  ...
  * **datastore** (`Optional`[[`Datastore`](datastores.md#wayflowcore.datastore.Datastore)]) – 
...
* **Parameters:**
  ...
  * **datastore** (`Optional`[[`Datastore`](datastores.md#wayflowcore.datastore.Datastore)]) – Datastore on which to store the cache. If not specified, an in-memory Datastore will be created automatically.
