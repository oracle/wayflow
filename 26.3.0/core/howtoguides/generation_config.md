...
[PromptExecutionStep](../api/flows.md#promptexecutionstep) also exposes them as an additional `logprobs` output.

#### NOTE
`top_logprobs` is only available for raw text generation.
It is not supported with structured generation in [PromptExecutionStep](../api/flows.md#promptexecutionstep),
...
For flows, you can request logprobs directly on [PromptExecutionStep](../api/flows.md#promptexecutionstep).
