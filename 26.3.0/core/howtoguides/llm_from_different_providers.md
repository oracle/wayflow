...
- [GeminiModel](../api/llmmodels.md#geminimodel)
...
<a id="openaicompatible-custom-tls"></a>
...
[Gemini](https://deepmind.google/technologies/gemini/) models can be accessed through
