<a id="top-howtoevaluation"></a>

# How to Evaluate Assistants![python-icon](_static/icons/python-icon.svg) Download Python Script

Python script/notebook for this guide.

[Evaluate Assistants how-to script](../end_to_end_code_examples/howto_evaluation.py)

#### Prerequisites
This guide assumes familiarity with:

- [WayFlow Agents](../tutorials/basic_agent.md)
...
This is what the [AssistantEvaluator](../api/evaluation.md#assistantevaluator) is designed for.

The `AssistantEvaluator` works as follows:

![image](core/_static/howto/assistant_evaluator.png)

Evaluation is performed by running an [AssistantEvaluator](../api/evaluation.md#assistantevaluator) over a set of [EvaluationTask](../api/evaluation.md#evaluationtask) instances within an
[EvaluationEnvironment](../api/evaluation.md#evaluationenvironment). The environment provides the assistant under test, a human proxy (if needed), and optional lifecycle hooks
(init/reset). Metrics are produced by [TaskScorer](../api/evaluation.md#taskscorer) implementations attached to the tasks.
...
Click on the card at the [top of this page](#top-howtoevaluation) to download the full code for this guide or copy the code below.
