...
[OAuth flow from MCP](https://modelcontextprotocol.io/specification/2025-11-25/basic/authorization),
...
**API Reference:** [OAuthClientConfig](../api/auth.md#oauthclientconfig)
...
# %%[markdown]
## Configuring toolbox retry policy
...
# %%[markdown]
## Configuring direct tool retry policy
