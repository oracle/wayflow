...
### *class* wayflowcore.models._requesthelpers.StreamChunkType(value, names=<not given>, \*values, module=None, qualname=None, type=None, start=1, boundary=None)
...
### *class* wayflowcore.models.llmgenerationconfig.LlmGenerationConfig(max_tokens=None, temperature=None, top_p=None, stop=None, frequency_penalty=None, top_logprobs=None, extra_args=<factory>, \*, id=<factory>, \_\_metadata_info_\_=<factory>)
...
### *class* wayflowcore.models.openaiapitype.OpenAIAPIType(value, names=<not given>, \*values, module=None, qualname=None, type=None, start=1, boundary=None)
...
### *class* wayflowcore.models.openaicompatiblemodel.OpenAICompatibleModel(model_id, base_url, proxy=None, api_key=None, key_file=None, cert_file=None, ca_file=None, generation_config=None, supports_structured_generation=True, supports_tool_calling=True, api_type=OpenAIAPIType.CHAT_COMPLETIONS, \_\_metadata_info_\_=None, id=None, name=None, description=None, retry_policy=None)
...
* **Parameters:**
  ...
  * **key_file** (`Optional`[`str`]) – The path to an optional client private key file (PEM format).
  * **cert_file** (`Optional`[`str`]) – The path to an optional client certificate chain file (PEM format).
  * **ca_file** (`Optional`[`str`]) – The path to an optional trusted CA certificate file (PEM format) to verify the server.
  ...
  * **description** (`Optional`[`str`]) – Description of the component.
  * **\_\_metadata_info_\_** (*Dict* *[**str* *,* *Any* *]*  *|* *None*)
  * **retry_policy** ([*RetryPolicy*](retries.md#wayflowcore.retrypolicy.RetryPolicy) *|* *None*)
...
### *class* wayflowcore.models.openaimodel.OpenAIModel(model_id='gpt-4o-mini', api_key=None, generation_config=None, proxy=None, api_type=OpenAIAPIType.CHAT_COMPLETIONS, retry_policy=None, \_\_metadata_info_\_=None, id=None, name=None, description=None)
...
### *class* wayflowcore.models.geminimodel.GeminiModel(model_id, auth, proxy=None, generation_config=None, supports_structured_generation=True, supports_tool_calling=True, \_\_metadata_info_\_=None, id=None, name=None, description=None, retry_policy=None)
...
* **Parameters:**
  * **model_id** (`str`) – ID of the model.
  * **generation_config** (`Optional`[[`LlmGenerationConfig`](#wayflowcore.models.llmgenerationconfig.LlmGenerationConfig)]) – Parameters for LLM generation.
  * **chat_template** – Default template for chat completion.
  * **agent_template** – Default template for agents using this model.
  * **supports_structured_generation** (`Optional`[`bool`]) – Whether the model supports structured generation or not. When set to None,
    the model will be prompted with a response format and it will check it can use
    structured generation.
  * **supports_tool_calling** (`Optional`[`bool`]) – Whether the model supports tool calling or not. When set to None,
  ...
  * **name** (`Optional`[`str`]) – Name of the component.
  * **description** (`Optional`[`str`]) – Description of the component.
  * **auth** ([*GeminiApiKeyAuth*](#wayflowcore.models.geminimodel.GeminiApiKeyAuth) *|* [*GeminiCloudAuth*](#wayflowcore.models.geminimodel.GeminiCloudAuth))
  * **proxy** (*str* *|* *None*)
  * **\_\_metadata_info_\_** (*Dict* *[**str* *,* *Any* *]*  *|* *None*)
  * **retry_policy** ([*RetryPolicy*](retries.md#wayflowcore.retrypolicy.RetryPolicy) *|* *None*)
...
### *class* wayflowcore.models.geminimodel.GeminiApiKeyAuth(\*\*data)
...
### *class* wayflowcore.models.geminimodel.GeminiCloudAuth(\*\*data)
...
* **Parameters:**
  * **project_id** (*str* *|* *None*)
  * **location** (*str*)
  * **vertex_credentials** (*str* *|* *Dict* *[**str* *,* *Any* *]*  *|* *None*)
...
#### vertex_credentials *: `Union`[`str`, `Dict`[`str`, `Any`], `None`]*

### Ollama Models

<a id="ollamamodel"></a>

### *class* wayflowcore.models.ollamamodel.OllamaModel(model_id, host_port='localhost:11434', proxy=None, key_file=None, cert_file=None, ca_file=None, generation_config=None, supports_structured_generation=True, supports_tool_calling=True, \_\_metadata_info_\_=None, id=None, name=None, description=None, retry_policy=None)
...
### *class* wayflowcore.models.vllmmodel.VllmModel(model_id, host_port, proxy=None, key_file=None, cert_file=None, ca_file=None, generation_config=None, supports_structured_generation=True, supports_tool_calling=True, api_type=OpenAIAPIType.CHAT_COMPLETIONS, api_key='<[EMPTY#KEY]>', retry_policy=None, \_\_metadata_info_\_=None, id=None, name=None, description=None)
...
### *class* wayflowcore.models.ocigenaimodel.OCIGenAIModel(\*, model_id, compartment_id=None, client_config=None, serving_mode=None, provider=None, generation_config=None, id=None, name=None, description=None, \_\_metadata_info_\_=None, retry_policy=None, service_endpoint=None, auth_type=None, auth_profile='DEFAULT', api_type=OciAPIType.OCI, conversation_store_id=None)
...
* **Parameters:**
  ...
  * **serving_mode** (`Optional`[[`ServingMode`](#wayflowcore.models.ociclientconfig.ServingMode)]) – OCI serving mode for the model. Either `ServingMode.ON_DEMAND` or `ServingMode.DEDICATED`.
...
### *class* wayflowcore.models.ociclientconfig.ServingMode(value, names=<not given>, \*values, module=None, qualname=None, type=None, start=1, boundary=None)
...
### *class* wayflowcore.models.ocigenaimodel.ModelProvider(value, names=<not given>, \*values, module=None, qualname=None, type=None, start=1, boundary=None)
...
### *class* wayflowcore.models.ocigenaimodel.OciAPIType(value, names=<not given>, \*values, module=None, qualname=None, type=None, start=1, boundary=None)
...
### *class* wayflowcore.models.ociclientconfig.\_OCIAuthType(value, names=<not given>, \*values, module=None, qualname=None, type=None, start=1, boundary=None)
