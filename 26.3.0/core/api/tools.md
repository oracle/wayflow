...
#### retry_policy *: `Optional`[[`RetryPolicy`](retries.md#wayflowcore.retrypolicy.RetryPolicy)]*
...
### *class* wayflowcore.mcp.MCPTool(name, client_transport, description=None, input_descriptors=None, output_descriptors=None, \_validate_server_exists=True, \_validate_tool_exist_on_server=True, \_\_metadata_info_\_=None, id=None, requires_confirmation=False, retry_policy=None)
...
#### retry_policy *: `Optional`[[`RetryPolicy`](retries.md#wayflowcore.retrypolicy.RetryPolicy)]* *= None*
...
### *class* wayflowcore.mcp.MCPToolBox(id=<factory>, requires_confirmation=None, client_transport=<factory>, tool_filter=None, retry_policy=None, \_validate_mcp_client_transport=True, \*, \_\_metadata_info_\_=<factory>, name='', description=None)
...
<a id="authlessmcpenabled"></a>

### wayflowcore.mcp.authless_mcp_enabled()
...
[`authless_mcp_enabled()`](#wayflowcore.mcp.authless_mcp_enabled) to scope the opt-in to the code that needs it.
...
### *class* wayflowcore.mcp.SSETransport(url=<factory>, headers=None, sensitive_headers=None, timeout=5, retry_policy=None, sse_read_timeout=300, auth=None, follow_redirects=True, session_parameters=<factory>, \*, id=<factory>, \_\_metadata_info_\_=<factory>)
...
### *class* wayflowcore.mcp.SSEmTLSTransport(url=<factory>, headers=None, sensitive_headers=None, timeout=5, retry_policy=None, sse_read_timeout=300, auth=None, follow_redirects=True, session_parameters=<factory>, key_file=<factory>, cert_file=<factory>, ssl_ca_cert=<factory>, check_hostname=True, \*, id=<factory>, \_\_metadata_info_\_=<factory>)
...
### *class* wayflowcore.mcp.StreamableHTTPTransport(url=<factory>, headers=None, sensitive_headers=None, timeout=5, retry_policy=None, sse_read_timeout=300, auth=None, follow_redirects=True, session_parameters=<factory>, \*, id=<factory>, \_\_metadata_info_\_=<factory>)
...
### *class* wayflowcore.mcp.StreamableHTTPmTLSTransport(url=<factory>, headers=None, sensitive_headers=None, timeout=5, retry_policy=None, sse_read_timeout=300, auth=None, follow_redirects=True, session_parameters=<factory>, key_file=<factory>, cert_file=<factory>, ssl_ca_cert=<factory>, check_hostname=True, \*, id=<factory>, \_\_metadata_info_\_=<factory>)
...
### wayflowcore.tools.toolhelpers.tool(func_or_name=None, func=None, /, description_mode=DescriptionMode.INFER_FROM_SIGNATURE, output_descriptors=None, requires_confirmation=False)

Make tools out of callables, can be used as a decorator or as a wrapper.

* **Parameters:**
  * **\*args** – The optional name and callable to convert to a `ServerTool`.
    See the example section for common usage patterns.
  * **description_mode** (`Literal`[`<DescriptionMode.INFER_FROM_SIGNATURE: 'infer_from_signature'>`, `<DescriptionMode.ONLY_DOCSTRING: 'only_docstring'>`, `<DescriptionMode.EXTRACT_FROM_DOCSTRING: 'extract_from_docstring'>`, `'infer_from_signature'`, `'only_docstring'`, `'extract_from_docstring'`]) – 
  ...
  * **func_or_name** (*Callable* *[* *[* *...* *]* *,* *Any* *]*  *|* *str* *|* *None*)
