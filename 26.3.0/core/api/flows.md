...
### *class* wayflowcore.steps.promptexecutionstep.PromptExecutionStep(prompt_template, llm, generation_config=None, top_logprobs=None, \_structured_generation_mode=StructuredGenerationMode.JSON_GENERATION, send_message=False, input_descriptors=None, output_descriptors=None, input_mapping=None, output_mapping=None, name=None, \_\_metadata_info_\_=None)
...
* **Parameters:**
  ...
  * **top_logprobs** (`Optional`[`int`]) – If not None, the step will return the top logprobs for each token.
...
Output key for the token logprobs returned by the LLM (when enabled).
...
### *class* wayflowcore.steps.promptexecutionstep.StructuredGenerationMode(value, names=<not given>, \*values, module=None, qualname=None, type=None, start=1, boundary=None)
...
### *class* wayflowcore.steps.searchstep.SearchStep(datastore, collection_name, k=3, where=None, columns_to_exclude=None, search_config=None, input_descriptors=None, output_descriptors=None, input_mapping=None, output_mapping=None, name=None, \_\_metadata_info_\_=None)
...
* **Parameters:**
  * **datastore** ([`Datastore`](datastores.md#wayflowcore.datastore.Datastore)) – Searchable instance that contains collections with search capability.
  * **collection_name** (`str`) – Name of the collection within the datastore that is to be searched on.
  * **k** (`int`) – Upper limit on the number of records to retrieve.
  * **search_config** (`Optional`[`str`]) – Optional name of the search configuration to use. If None, uses default.
...
Output key for the list of retrieved documents from the `SearchStep`.
...
Input key for the query to be used to search the rows in the datastore.
...
* **Parameters:**
  * **write_variables** (`Optional`[`List`[[`Variable`](variables.md#wayflowcore.variable.Variable)]]) – list of `Variable``s to write to. Leave it as default (``None`) or empty (`[]`) if you don’t have a write operation in this step.
  * **read_variables** (`Optional`[`List`[[`Variable`](variables.md#wayflowcore.variable.Variable)]]) – list of `Variable``s to read from. Leave it as default (``None`) or empty (`[]`) if you don’t have a read operation in this step.
  * **write_operations** (`Union`[[`VariableWriteOperation`](variables.md#wayflowcore.variable.VariableWriteOperation), `Dict`[`str`, [`VariableWriteOperation`](variables.md#wayflowcore.variable.VariableWriteOperation)], `None`]) – 
...
### *class* wayflowcore.steps.getchathistorystep.MessageSlice(value, names=<not given>, \*values, module=None, qualname=None, type=None, start=1, boundary=None)
...
This step has for input descriptors all the variables extracted from the `url`, `method`, `data`, `params`, `headers` or `cookies` templates. See [TemplateRenderingStep](#templaterenderingstep) for concrete examples on how descriptors are extracted from text prompts.
...
* **Parameters:**
  ...
  * **num_retry_on_bad_http_request** (`Optional`[`int`]) – Deprecated in version 26.4.0 and will be removed in version 27.2.0.
  ...
  * **retry_policy** (`Optional`[[`RetryPolicy`](retries.md#wayflowcore.retrypolicy.RetryPolicy)]) – Provider-agnostic retry configuration for the remote request.
  ...
  * **\_\_metadata_info_\_** (*Dict* *[**str* *,* *Any* *]*  *|* *None*)
* **Raises:**
  **ValueError** – Thrown when both `data` and the deprecated `json_body` are set.
...
### *class* wayflowcore.property.ObjectProperty(name='', description='', default_value=<class 'wayflowcore.property._empty_default'>, enum=None, \_validate_default_type=False, \_\_metadata_info_\_=<factory>, properties=<factory>, additional_properties=True)
...
* **Parameters:**
  ...
  * **additional_properties** (`Union`[`bool`, [`Property`](#wayflowcore.property.Property)]) – Boolean indicating if the object accepts arbitrary properties, or Property that defines which types
    of additional properties are accepted. Default is True.
  * **enum** (*Tuple* *[**Any* *,*  *...* *]*  *|* *None*)
  * **\_validate_default_type** (*bool*)
  * **\_\_metadata_info_\_** (*Dict* *[**str* *,* *Any* *]*)

#### additional_properties *: `Union`[`bool`, [`Property`](#wayflowcore.property.Property)]* *= True*
...
<a id="vectorproperty"></a>

### *class* wayflowcore.property.VectorProperty(name='', description='', default_value=<class 'wayflowcore.property._empty_default'>, enum=None, \_validate_default_type=False, \_\_metadata_info_\_=<factory>, dimensions=None, hidden=False)
...
* **Parameters:**
  ...
  * **default_value** (`Any`) – 
    ...
    * when **a value might not be yet produced / not passed as input** in a `Flow` (e.g. caught exception, some other branch execution, …),
      but you still want the flow to execute. Putting a default value helps ensuring that whatever happens before,
      the flow can always execute properly with some defaults if needed.
  * **dimensions** (`Optional`[`int`]) – Optional number of dimensions for the vector. If specified, will validate that vectors have the correct size.
  * **hidden** (`bool`) – Whether this property should be hidden from users (e.g., for auto-generated embeddings). Defaults to False.
  * **enum** (*Tuple* *[**Any* *,*  *...* *]*  *|* *None*)
  * **\_validate_default_type** (*bool*)
  * **\_\_metadata_info_\_** (*Dict* *[**str* *,* *Any* *]*)
...
### *class* wayflowcore.steps.step.StepExecutionStatus(value, names=<not given>, \*values, module=None, qualname=None, type=None, start=1, boundary=None)
...
* **Parameters:**
  ...
  * **branching_step_name** (`str` | `None`) – Optional name for the branching step. Uses automatically generated auto-incrementing
...
* **Parameters:**
  ...
  * **from_branch** (`list`[`str` | `None`] | `str` | `None`) – Optional source branch name(s) to use in the control flow edge(s).
    When a list, must be of the same length as the list of `source_step`.
  * **edge_name** (`str` | `None`) – Name for the edge. Defaults to f”control_edge_{source_step.name}_{dest_step.name}_{from_branch}”.
* **Return type:**
  [`FlowBuilder`](#wayflowcore.flowbuilder.FlowBuilder)
...
* **Parameters:**
  ...
  * **data_flow_edges** (`list`[[`DataFlowEdge`](#wayflowcore.dataconnection.DataFlowEdge)] | `None`) – Optional list of data flow edges.
  * **input_descriptors** (`list`[[`Property`](#wayflowcore.property.Property)] | `None`) – Optional list of inputs for the flow. If None, auto-detects as the list of
    inputs that are not generated at some point in the execution of the flow.
  * **output_descriptors** (`list`[[`Property`](#wayflowcore.property.Property)] | `None`) – Optional list of outputs for the flow. If None, auto-detects as the
