...
from wayflowcore.events.event import _PII_TEXT_MASK, FlowExecutionIterationStartedEvent
...
def test_tracing_info_stringifies_unserializable_values() -> None:
    ...
    event = FlowExecutionIterationStartedEvent(execution_state=execution_state)
