...
from worker import A2AAgentWorker
...
class A2AServer:
    def __init__(
        ...
        worker = A2AAgentWorker(broker=broker, storage=storage, agent=agent)
        ...
        self.app = A2AApp(storage=storage, broker=broker, lifespan=lifespan)
