...
class AgentConversationExecutor(ConversationExecutor):
    ...
    async def _handle_tool_call(
        ...
        if raised_exception and isinstance(raised_exception, AuthInterrupt):
            # when the tool execution is interrupted by an AuthInterrupt,
            # we return the corresponding execution status attached to the
            # exception (e.g., can be an AuthChallengeRequestStatus)
