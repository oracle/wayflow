...
class FinishedStatus(ExecutionStatus):
    ...
    def _deserialize_from_dict(
        ...
        return FinishedStatus(
            ...
            _final_step_name=input_dict.get("_final_step_name"),
...
class AuthChallengeRequestStatus(ExecutionStatus):
    ...
    def _serialize_to_dict(self, serialization_context: "SerializationContext") -> Dict[str, Any]:
        return {
            "client_transport_id": self.client_transport_id,
            "_conversation_id": self._conversation_id,
            # we explicitely do not serialize the auth challenge request
    ...
    def _deserialize_from_dict(
        ...
        return AuthChallengeRequestStatus(
            ...
            # we explicitely do not deserialize the auth challenge request
            # which may include sensitive information
        )
