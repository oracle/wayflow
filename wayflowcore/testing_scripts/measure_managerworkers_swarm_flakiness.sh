...
output_dir="${FLAKY_OUTPUT_DIR:-.flaky_results_$(date +%Y%m%d_%H%M%S)_managerworkers_swarm}"
tmux_session="${FLAKY_TMUX_SESSION:-wayflow-flaky}"
run_in_tmux=false
stop_tmux=false
attach_tmux=false
runner_args=()
...
usage() {
  cat <<'EOF'
Usage:
  wayflowcore/testing_scripts/measure_managerworkers_swarm_flakiness.sh [--repeat N] [--parallel] [--output-dir DIR]
  wayflowcore/testing_scripts/measure_managerworkers_swarm_flakiness.sh --tmux [--parallel] [--repeat N] [--output-dir DIR]
  wayflowcore/testing_scripts/measure_managerworkers_swarm_flakiness.sh --stop
  wayflowcore/testing_scripts/measure_managerworkers_swarm_flakiness.sh --attach
  wayflowcore/testing_scripts/measure_managerworkers_swarm_flakiness.sh --check-collection
...
Environment:
  ...
  FLAKY_TMUX_SESSION  Default tmux session name. Defaults to wayflow-flaky.
...
Notes:
  ...
  Read each log for the decorator's suggested docstring and max_attempts.
  --tmux starts a detached tmux session. Stop it with:
    wayflowcore/testing_scripts/measure_managerworkers_swarm_flakiness.sh --stop
EOF
}
...
tests=(
  "mw_servertool_confirmation|wayflowcore/tests/test_managerworkers.py::test_managerworkers_execution_works_with_servertool_confirmation"
  ...
  "mw_exception_raises|wayflowcore/tests/test_managerworkers.py::test_managerworkers_can_do_multiple_tool_calling_with_tool_raising_exception_raises_error"
  ...
  "swarm_servertool_confirmation|wayflowcore/tests/test_swarm.py::test_swarm_can_handle_server_tool_with_confirmation"
  "swarm_clienttool_confirmation|wayflowcore/tests/test_swarm.py::test_swarm_can_handle_client_tool_with_confirmation"
  "swarm_clienttool|wayflowcore/tests/test_swarm.py::test_swarm_can_handle_client_tool"
  "swarm_always_handoff|wayflowcore/tests/test_swarm.py::test_swarm_uses_handoff_tool_in_always_handoff_mode"
  "swarm_optional_takeover|wayflowcore/tests/test_swarm.py::test_swarm_uses_handoff_tool_when_sub_agent_can_take_over_in_optional_handoff_mode"
  "swarm_send_message_collaboration|wayflowcore/tests/test_swarm.py::test_swarm_uses_send_message_when_collaboration_needed_in_optional_handoff_mode"
  "swarm_multiple_tool_calling|wayflowcore/tests/test_swarm.py::test_swarm_can_do_multiple_tool_calling_when_appropriate"
  "swarm_exception_raises|wayflowcore/tests/test_swarm.py::test_swarm_can_do_multiple_tool_calling_with_tool_raising_exception_raises_error"
...
if [[ "$check_collection" == true ]]; then
  ...
  echo "All test ids collected successfully."
  exit 0
fi
