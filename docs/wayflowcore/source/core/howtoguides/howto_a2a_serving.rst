...
Now that you have learned how to serve WayFlow assistants using A2A protocol, you may proceed to :doc:`How to Use A2A Agents <howto_a2aagent>` to learn how consume an A2A-served agent.
