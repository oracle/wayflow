...
# docs-title: Tutorial - Build a Simple Code Review Assistant
...
# .. start-##_Define_the_tool_that_retrieves_the_PR_diff
...
# .. start-##_Define_a_mocked_PR_diff
MOCK_DIFF = """
...
+    main()
""".strip()
# .. end-##_Define_a_mocked_PR_diff

@tool(description_mode="only_docstring")  # docs-skiprow
def local_get_pr_diff_tool(repo_dirpath: str) -> str:  # docs-skiprow
    """  # docs-skiprow
    Retrieves code diff with a git command given the  # docs-skiprow
    path to the repository root folder.  # docs-skiprow
    """  # docs-skiprow
    return MOCK_DIFF  # docs-skiprow

# .. start-##_Create_the_flow_that_retrieves_the_diff_of_a_PR
...
# .. end-##_Alternative_step_that_retrieves_the_PR_diff_through_an_API_call

# .. start-##_Test_the_flow_that_retrieves_the_PR_diff
...
# .. end-##_Test_the_flow_that_retrieves_the_PR_diff

# .. start-##_Define_the_tool_that_formats_the_diff_for_the_LLM
PR_BOT_CHECKS = [
    """
...
# .. end-##_Define_the_tool_that_formats_the_diff_for_the_LLM

# .. start-##_Create_the_flow_that_generates_review_comments
...
# .. end-##_Create_the_flow_that_generates_review_comments

# .. start-##_Test_the_flow_that_generates_review_comments
...
print(FILEPATH_LIST)
# .. end-##_Test_the_flow_that_generates_review_comments


# .. start-##_Create_tool_that_formats_the_review_comments
@tool(description_mode="only_docstring")
def flatten_information(
    ...
    return result
# .. end-##_Create_tool_that_formats_the_review_comments

# .. start-##_Create_flow_that_posts_review_comments_to_bitbucket
import json
...
# .. end-##_Create_flow_that_posts_review_comments_to_bitbucket
...
# .. start-##_Test_flow_that_posts_review_comments
...
# .. end-##_Test_flow_that_posts_review_comments

# .. start-##_Create_flow_that_performs_the_review
...
# .. end-##_Create_flow_that_performs_the_review

# .. start-##_Tests_flow_that_performs_the_review
# Replace the path below with the path to your actual codebase sample git repository.
PATH_TO_DIR = "path/to/repository_root"
...
NESTED_COMMENT_LIST = execution_status.output_values[NESTED_COMMENT_LIST_IO]
# .. end-##_Tests_flow_that_performs_the_review
