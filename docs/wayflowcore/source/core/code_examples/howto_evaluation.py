...
# fmt: off
# mypy: ignore-errors
# docs-title: WayFlow Code Example - How to Evaluate Assistants
...
# .. end-##_Define_the_environment


# .. start-##_Define_the_scorer
...
# .. end-##_Define_the_scorer

# .. start-##_Define_the_evaluation_config
data = [
    {
...
# .. end-##_Define_the_evaluation_config

# tasks = []
# .. start-##_Run_the_evaluation
