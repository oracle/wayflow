...
[Ollama](https://ollama.com/) is a lightweight framework for running Large Language Models (LLMs) on a local machine.
...
**Step 1:** Go to the [Ollama](https://ollama.com/) website and click on `Download`.

![image](core/_static/ollama/ollama_frontpage.png)
...
![image](core/_static/ollama/ollama_extract1_2.png)
...
![image](core/_static/ollama/ollama_extract2_2.png)

You may be prompted to enter your password to complete the installation.

![image](core/_static/ollama/ollama_install1_3.png)![image](core/_static/ollama/ollama_install2_3.png)![image](core/_static/ollama/ollama_install3_3.png)
...
![image](core/_static/ollama/ollama_in_terminal.png)
...
For a comprehensive list of available models, visit the [Ollama Library](https://ollama.com/search).
...
To learn more, check out tutorials on how [Build a Simple Conversational Assistant with Agents](../tutorials/basic_agent.md) as well as how to [Build a Simple Fixed-Flow Assistant with Flows](../tutorials/basic_flow.md).
