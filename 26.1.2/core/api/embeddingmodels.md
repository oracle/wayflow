...
#### *abstract async* embed_async(data)
...
### *class* wayflowcore.embeddingmodels.openaicompatiblemodel.OpenAICompatibleEmbeddingModel(model_id, base_url, api_key=None, key_file=None, cert_file=None, ca_file=None, \_\_metadata_info_\_=None, id=None, name=None, description=None, retry_policy=None)
...
### *class* wayflowcore.embeddingmodels.openaimodel.OpenAIEmbeddingModel(model_id, api_key=None, \_\_metadata_info_\_=None, id=None, name=None, description=None, retry_policy=None, \_validate_api_key=True)
...
### *class* wayflowcore.embeddingmodels.vllmmodel.VllmEmbeddingModel(model_id, base_url, api_key=None, key_file=None, cert_file=None, ca_file=None, \_\_metadata_info_\_=None, id=None, name=None, description=None, retry_policy=None)
...
### *class* wayflowcore.embeddingmodels.ocigenaimodel.OCIGenAIEmbeddingModel(model_id, config, compartment_id=None, \_\_metadata_info_\_=None, id=None, name=None, description=None, retry_policy=None)
...
### *class* wayflowcore.embeddingmodels.ollamamodel.OllamaEmbeddingModel(model_id, base_url, api_key=None, key_file=None, cert_file=None, ca_file=None, \_\_metadata_info_\_=None, id=None, name=None, description=None, retry_policy=None)
