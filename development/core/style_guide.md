...
and [Chicago Manual of Style](https://www.chicagomanualofstyle.org/home.html).
...
If you consider contributing to the documentation, please read our [contributing guidelines](contributing.md).
